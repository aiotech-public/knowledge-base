...
Полем визита `pwa_hess_reason` (колонка `PWA Hess Reason`): по нему видно, ушёл визит на оффер из запущенного установленного приложения или мимо установки. Этим и объясняется расхождение «до оффера дошло больше визитов, чем зафиксировано `Install`». Значения и как их читать — [how-to/pwa.md](../how-to/pwa.md).
